...
Most of my CTF-style write-ups in this folder are a walkthrough format, where I documented the questions, my logic, and then the correct answer. I do also have a Full Reports folder, in which I store more robust write-ups, including recommendations based on findings. The current example in this folder follows a phishing attack from email to command and control, to exfiltration and, finally, to evidence removal.

Through Blue Team Labs Online (BTLO), I've learned to develop my defensive and investigative skills. I've explored how to use VirusTotal to get a closer look at potential malware and brush up on open source intelligence (OSINT) digging. I've also gained experience exploring metadata, how to utilize Wireshark in new and different ways, how to analyze a phishing attempt via email header information, and read log files via Linux command line. I have also learned how to read reports and parse for important information.
